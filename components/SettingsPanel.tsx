          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="flex gap-2 mb-6">
              <input 
                ...
                className="flex-grow px-4 py-3 bg-slate-50 dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 rounded-xl text-sm font-bold outline-none focus:border-notera-purple"
              />
